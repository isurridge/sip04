...
public class RegistrationForm {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
			...
			.append("breakout2", breakout2)
			.append("breakout3", breakout3)
			.append("breakout4", breakout4)
			.append("breakout5", breakout5)
			.append("breakout6", breakout6)
			.append("breakout7", breakout7)
			.append("breakout8", breakout8)
